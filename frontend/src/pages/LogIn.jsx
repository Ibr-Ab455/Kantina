        ...
        <div>
            <form className='space-y-6' >
                <div className='flex flex-col space-y-2'>
                    ...
                    <input type='email' placeholder='' id='email' className='w-[170%] p-2 rounded-[15px] outline  border-2 border-gray-500 text-white bg-black' />
                </div>

                <div className='flex flex-col space-y-2'>
                    <label className='text-xl text-white'>Password</label>
                    <input type='password' placeholder='******' id='password' className='w-[170%] p-2 rounded-[15px] outline border-gray-200 text-white bg-black'/>
                </div>
